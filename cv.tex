...
I seek problems that more people should care about. I enjoy (certain kinds of)
mathematics. I like to make things fast and parallel, but not at the cost of
extra complexity. I prefer to work with people and in cooperative environments.
I like static types and often prefer the ``straightforward'' imperative code
with minimal and contained state over heavy abstractions that ``functional''
approaches sometimes give rise to. E.g.\ today my needs are mostly satisfied
with C++, Python, and Nix. I'm open to new tools and new problems, and there's
